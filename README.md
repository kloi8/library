...
- Учёт ролей реализован через модель Profile (создаётся отдельно через админку или сигнал)

## Примечание
Это простая рабочая база: для продакшена нужно дополнить валидацию, загрузку файлов, безопасность и тесты.
